...
class Permission extends AbstractUIObject
{
    ...
    public function render()
    {
        ...
        XeFrontend::js('/assets/core/permission/PermissionTag.js')->load();
        XeFrontend::js('/assets/core/permission/PermissionTagSuggestion.js')->load();
        XeFrontend::js('/assets/core/permission/PermissionInclude.js')->load();
        XeFrontend::js('/assets/core/permission/PermissionExclude.js')->load();
        XeFrontend::js('/assets/core/permission/Permission.js')->load();
        XeFrontend::js('/assets/core/permission/PermissionRenderer.js')->load();
