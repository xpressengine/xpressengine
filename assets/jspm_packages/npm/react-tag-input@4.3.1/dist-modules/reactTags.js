...
var ReactTags = _react2.default.createClass({
  ...
  componentWillMount: function componentWillMount() {
    this.setState({classNames: _extends({}, DefaultClassNames, this.props.classNames)});
  },
  ...
  render: function render() {
    ...
    var tagInput = !this.props.readOnly ? _react2.default.createElement('div', {className: this.state.classNames.tagInput}, _react2.default.createElement('input', {
      ref: 'input',
      type: 'text',
    ...
    return _react2.default.createElement('div', {className: this.state.classNames.tags}, _react2.default.createElement('div', {className: this.state.classNames.selected}, tagItems, this.props.inline && tagInput), !this.props.inline && tagInput);
  }
});
module.exports = {
