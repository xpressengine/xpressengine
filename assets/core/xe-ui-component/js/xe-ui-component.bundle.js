"bundle";
System.registerDynamic("xecore:/xe-ui-component/js/_dropdown.js", ["npm:jquery@2.2.2.js"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
  (function(root, factory) {
    if (typeof define === 'function' && define.amd) {
      ...
      factory(exports, $__require('npm:jquery@2.2.2.js'));
    } else {
      factory({}, root.jQuery);
    }
    ...
    Dropdown.prototype.toggle = function(e) {
      ...
      if (!isActive) {
        ...
        $parent.toggleClass('open').trigger($.Event('shown.bs.xe-dropdown', relatedTarget));
      }
      return false;
    };
    ...
    function Plugin(option) {
      return this.each(function() {
        ...
        if (!data)
          $this.data('bs.xe-dropdown', (data = new Dropdown(this)));
    ...
    $(document).on('click.bs.xe-dropdown.data-api', clearMenus).on('click.bs.xe-dropdown.data-api', '.xe-dropdown form', function(e) {
      e.stopPropagation();
    }).on('click.bs.xe-dropdown.data-api', toggle, Dropdown.prototype.toggle).on('keydown.bs.xe-dropdown.data-api', toggle, Dropdown.prototype.keydown).on('keydown.bs.xe-dropdown.data-api', '.xe-dropdown-menu', Dropdown.prototype.keydown);
  }));
...
System.registerDynamic("xecore:/xe-ui-component/js/_modal.js", ["npm:jquery@2.2.2.js"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
