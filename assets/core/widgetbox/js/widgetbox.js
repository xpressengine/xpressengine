;(function (exports, $) {
  ...
  Col.prototype = {
    ...
    removeGrid: function (mode) {
      var self = this, temp = {}, keys = Object.keys(this.grid).filter(function (key) {
        return key !== mode;
      });
    ...
    render: function () {
      var html = '', isWidget = this.rows.length < 1;
  ...
  exports.WidgetBox = (function () {
    ...
    var _this, _options = {}, _rows = [], _flat = {};
      ...
      bindEvents: function () {
        ...
        _this.$colControls.find('button').click(function () {
          var control = $(this).data('control'),
            mode = $('select[data-type=mode]', _this.$colControls).val(),
            span = $('select[data-type=span]', _this.$colControls).val(),
            $selected = _this.$editor.find('.selected');
        ...
        _this.$btnPlaceWidget.click(function () {
          ...
          var attr = {}, data = {}, inputs = $('#widgetGen').widgetGenerator('data');
          for (var i in inputs) {
            if (i.indexOf('@') === 0) {
