 ...
 * Frontend::js('assets/core/common/js/xe.js')->appendTo('head')->load();
 *
 * // xe.js파일을 body의 상단에 로드함.
 * Frontend::js('assets/core/common/js/xe.js')->prependTo('body')->load();
 * ```
 *
 * ### 우선순위 지정
 *
 ...
 * Frontend::js('assets/core/common/js/xe.js')
 ...
 * ```php
 * // 로드된 xe.js파일을 언로드함.
 * Frontend::js('assets/core/common/js/xe.js')->unload();
 * ```
 *
 * ## css 파일 로드하기
 *
 ...
 * Frontend::js('assets/core/common/css/xe.css')->appendTo('body')->before('assets/vendor/bootstrap.css')->load();
 * ```
 *
 * ## meta 태그 추가
 *
