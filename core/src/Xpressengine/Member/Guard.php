...
/**
 * 이 클래스는 Xpressengine의 회원 인증 관련 기능을 처리하는 클래스이다.
...
class Guard extends LaravelGuard implements GuardInterface
{
     ...
     * 만약 로그인한 사용자가 없을 경우 \Xpressengine\Member\Entities\Guest의 인스턴스를 반환한다.
     *
     ...
     *
     * @return \Xpressengine\Member\Entities\Guest
     */
