...
class MailRepositoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testConstruct()
    {
        ...
        $this->assertInstanceOf(MailRepositoryInterface::class, new MailRepository($conn));
    }
    ...
    public function testInsert()
    {
        ...
        $conn = $this->makeConnection();
        $conn->shouldReceive('table')->with('member_mails')->once()->andReturn($query);
    ...
    protected function getRepository($conn = null)
    {
        ...
        $repo = Mockery::mock(
            '\Xpressengine\Member\Repositories\Database\MailRepository[getCurrentTime]',
            [$conn]
