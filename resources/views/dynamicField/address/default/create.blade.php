<div class="form-group">
    ...
    <div class="xe-form-inline">
        <input type="text" name="{{$key['postcode']}}" placeholder="{{xe_trans('xe::postCode')}}" readonly="readonly" class="xe-form-control">
    ...
    <div class="xe-form-inline">
        <input type="text" name="{{$key['address1']}}" class="xe-form-control" placeholder="{{xe_trans('xe::address')}}" readonly="readonly">
        <input type="text" name="{{$key['address2']}}" class="xe-form-control" placeholder="{{xe_trans('xe::detailedAddress')}}">
    </div>
</div>