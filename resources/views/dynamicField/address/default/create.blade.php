<input type="text" name="{{$key['postcode']}}" placeholder="{{xe_trans('xe::postCode')}}" readonly="readonly" class="form-control">
...
<input type="text" name="{{$key['address1']}}" class="d_form large" placeholder="{{xe_trans('xe::address')}}" readonly="readonly">
<input type="text" name="{{$key['address2']}}" class="d_form large" placeholder="{{xe_trans('xe::detailedAddress')}}">
