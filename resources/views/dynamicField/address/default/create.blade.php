<div class="xe-form-group xe-dynamicField">
    ...
    <div class="xe-form-inline">
        <input type="text" name="{{$key['postcode']}}" placeholder="{{xe_trans('xe::postCode')}}" readonly="readonly" class="xe-form-control" value="{{Request::old($key['postcode'])}}" data-valid-name="{{ xe_trans('xe::postCode') }}">
    ...
    <div class="xe-form-inline">
        <input type="text" name="{{$key['address1']}}" class="xe-form-control" placeholder="{{xe_trans('xe::address')}}" readonly="readonly" value="{{Request::old($key['address1'])}}">
        <input type="text" name="{{$key['address2']}}" class="xe-form-control" placeholder="{{xe_trans('xe::detailedAddress')}}" value="{{Request::old($key['address2'])}}" data-valid-name="{{ xe_trans('xe::detailedAddress') }}">
    </div>
</div>
