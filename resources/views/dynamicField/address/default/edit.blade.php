<div class="xe-form-group xe-dynamicField">
    ...
    <div class="xe-form-inline">
        <input type="text" name="{{$key['address1']}}" class="xe-form-control" placeholder="{{xe_trans('xe::address')}}" readonly="readonly" value="{{$data['address1']}}">
        <input type="text" name="{{$key['address2']}}" class="xe-form-control" placeholder="{{xe_trans('xe::detailedAddress')}}" value="{{$data['address2']}}" data-valid-name="{{ xe_trans('xe::detailedAddress') }}">
    </div>
</div>
