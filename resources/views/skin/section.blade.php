    ...
    <ul class="skin-setting-list">
        ...
        <li class="on">
            ...
            <div class="skin-desc">
                ...
                <div class="btn-right">
                    <button type="button" class="__xe_skin-setting-btn btn btn-link" data-url="{{ route('settings.skin.section.setting', ['skinId'=>$skin->getId(), 'instanceId'=>$skinInstanceId]) }}"><i class="xi-cog"></i><span class="hidden-xs">설정</span></button>
                </div>
            </div>
        </li>
        @endforeach
...
<!-- Modal -->
{{
    app('xe.frontend')->html('skin-section-modal')->content('
    <div class="modal __xe_skin-modal" id="skinModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
