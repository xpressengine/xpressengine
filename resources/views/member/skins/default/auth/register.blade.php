    ...
    <form action="{{ route('auth.register') }}" method="post">
        ...
        <fieldset>
            ...
            <div class="auth_group {{--wrong--}}">
                ...
                <input type="text" id="name" class="xe-input-text" placeholder="사용자 이름" name="displayName" value="{{ old('displayName') }}">
            ...
            {!! uio('captcha') !!}
            @endif
            <button type="submit" class="xe-button xe-button-blue">가입하기</button>
        </fieldset>
    </form>
