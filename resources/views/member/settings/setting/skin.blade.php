<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
        ...
        <div class="panel-heading">
            <div class="row">
                ...
                <div class="right_btn pull-right" role="button" data-toggle="collapse" data-parent="#accordion" data-target="#authSkinSection">
                    ...
                    <button class="btn-close ico_gray pull-left"><i class="xi-angle-down"></i><i class="xi-angle-up"></i><span class="sr-only">메뉴닫기</span></button>
                </div>
    ...
    <div class="panel">
        <div class="panel-heading">
            <div class="row">
                <p class="text-title">프로필페이지 스킨</p>
