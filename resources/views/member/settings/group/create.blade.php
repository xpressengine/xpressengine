        ...
        <div class="panel-group">
            ...
            <form name="fGroupCreate" method="post" action="{{ route('manage.group.create') }}">
                ...
                <div class="panel-heading">
                    <div class="pull-left">
                        <h3 class="panel-title">새 그룹 추가</h3>
                    </div>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-12">
                            {!! uio('formText', ['label'=>'그룹명', 'placeholder'=>'이름을 입력하세요', 'value'=> old('name'), 'name'=>'name']) !!}
                        </div>
                        <div class="col-sm-12">
                            {!! uio('formTextarea', ['label'=>'소개글', 'placeholder'=>'설명을 작성해 주세요', 'value'=> old('description'), 'name'=>'description']) !!}
                        </div>
                    </div>
                </div>
