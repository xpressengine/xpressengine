        ...
        <fieldset>
            ...
            <div class="user-terms">
                ...
                @foreach ($terms as $term)
                    <div class="terms-box">
                        <label class="xu-label-checkradio">
                            <input type="checkbox" name="{{ $term->id }}" value="on" @if (old($term->id) == 'on') checked @endif>
                            <span class="xu-label-checkradio__helper"></span>
                ...
                <div class="button-box button-box--type2">
                    ...
                    <button type="submit" class="xu-button xu-button--primary xu-button--block xu-button--large xu-button--disabled" disabled="disabled">
