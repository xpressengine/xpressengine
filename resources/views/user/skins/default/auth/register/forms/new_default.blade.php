...
{{--loginId--}}
<div class="xu-form-group xu-form-group--large">
    <label class="xu-form-group__label" for="f-login_id">{{ xe_trans('xe::id') }}<em class="xu-form-group__label-required">*</em></label>
    <div class="xu-form-group__box">
...
@if (app('xe.config')->getVal('user.register.use_display_name') === true)
    <div class="xu-form-group xu-form-group--large">
        <label class="xu-form-group__label" for="f-name">{{ xe_trans(app('xe.config')->getVal('user.register.display_name_caption')) }}<em class="xu-form-group__label-required">*</em></label>
        <div class="xu-form-group__box">
