                ...
                <div class="panel">
                    <form name="fGroupCreate" method="post" action="{{ route('manage.group.edit', ['id' => $group->id]) }}">
                        ...
                        <div class="panel-heading">
                            <div class="pull-left">
                                <h3 class="panel-title">{{xe_trans('xe::groupEdit')}}</h3>
                            </div>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    {!! uio('formText', ['label'=>xe_trans('xe::groupName'), 'placeholder'=>xe_trans('xe::enterName'), 'value'=>$group->name, 'name'=>'name']) !!}
                                </div>
                                <div class="col-sm-12">
                                    {!! uio('formTextarea', ['label'=>xe_trans('xe::description'), 'placeholder'=>xe_trans('xe::enterDescription'), 'value'=>$group->description, 'name'=>'description']) !!}
                                </div>
                            </div>
                        </div>
