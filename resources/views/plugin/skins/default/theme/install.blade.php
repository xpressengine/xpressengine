        ...
        <form method="get" action="{{route('settings.theme.install')}}" class="plugin-install-form">
            ...
            <div class="panel admin-tab">
                ...
                <ul class="admin-tab-list">
                    ...
                    <li class="my_site @if (Request::get('sale_type') == 'my_site') on @endif"><a href="#" class="__plugin-install-link" data-type="sale_type" data-value="{{'my_site'}}">{{ xe_trans('xe::purchased') }} {{xe_trans('xe::theme')}}<span class="xe-badge xe-primary">{{$storeThemeCounts->mySite}}</span></a></li>
                </ul>
