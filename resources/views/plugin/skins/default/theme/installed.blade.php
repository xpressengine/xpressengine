                        ...
                        <div class="input-group search-group">
                            <div class="input-group-btn">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li>
                                        <a href="#" data-target="activated"><span>{{xe_trans('xe::activated')}} {{xe_trans('xe::theme')}}</span></a>
                                    </li>
                                    <li>
                                        <a href="#" data-target="deactivated"><span>{{xe_trans('xe::deactivated')}} {{xe_trans('xe::theme')}}</span></a>
                                    </li>
                                </ul>
                            </div>
