                        ...
                        <div class="left-group">
                            ...
                            @elseif($plugin->hasUpdate())
                                <div class="alert alert-danger" role="alert">
                                    ...
                                    <a href="{{ config('xe.plugin.store.detail_url').'/'.$plugin->getId() }}" class="alert-link" target="_blank">{{ xe_trans('xe::version') }} {{ $plugin->getLatestVersion() }} {{ xe_trans('xe::details') }}</a> {{ xe_trans('xe::or') }} <a href="{{ route('settings.plugins.show', [$plugin->getId()]) }}" class="alert-link">{{ xe_trans('xe::update') }}</a>
                                </div>
                            @endif
