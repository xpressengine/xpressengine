        ...
        <form method="get" action="{{route('settings.extension.install')}}">
            ...
            <div class="panel admin-tab">
                ...
                <ul class="admin-tab-list">
                    ...
                    <li class="my_site @if (Request::get('sale_type') == 'my_site') on @endif"><a href="{{ route('settings.extension.install', ['sale_type' => 'my_site']) }}">{{ xe_trans('xe::mySitePlugins') }} <span class="xe-badge xe-primary">{{$typeCounts['mySite']}}</span></a></li>
                </ul>
