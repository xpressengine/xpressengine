    ...
    this.validators = {
      accepted: function ($dst, parameters) {
        ...
        if (['yes', 'on', 1, true].indexOf(value) === -1) {
          that.error($dst, Lang.trans('validation.accepted', { attribute: $dst.data('valid-name') || $dst.attr('name') }))
          return false
        }
      ...
      checked: function ($dst, parameters) {
        ...
        if (checkedLenth < parseInt(min, 10) || checkedLenth > parseInt(max, 10)) {
          ...
          that.error($dst, Lang.trans(messageType))
          return false
        }
      ...
      required: function ($dst, parameters) {
        ...
        if (value === '') {
          that.error($dst, Lang.trans('validation.required', { attribute: $dst.data('valid-name') || $dst.attr('name') }))
          return false
        }
      ...
      alpha: function ($dst, parameters) {
        ...
        if (!pattern.test(value)) {
          that.error($dst, Lang.trans('validation.alpha', { attribute: $dst.data('valid-name') || $dst.attr('name') }))
          return false
        }
      ...
      alpha_num: function ($dst, parameters, alias) {
        ...
        if (pattern.test(value) === true) {
          ...
          that.error($dst, Lang.trans(langKey, { attribute: $dst.data('valid-name') || $dst.attr('name') }))
          return false
        }
      ...
      alpha_dash: function ($dst, parameters) {
        ...
        if (pattern.test(value)) {
          that.error($dst, Lang.trans('validation.alpha_dash', { attribute: $dst.data('valid-name') || $dst.attr('name') }))
          return false
        }
      ...
      array: function ($dst, parameters) {
        if (Array.isArray(that.getValue($dst))) {
          that.error($dst, Lang.trans('validation.array', { attribute: $dst.data('valid-name') || $dst.attr('name') }))
          return false
        }
      ...
      boolean: function ($dst, parameters) {
        ...
        if ([1, 0, '1', '0', true, false, 'true', 'false'].indexOf(value) === -1) {
          that.error($dst, Lang.trans('validation.boolean', { attribute: $dst.data('valid-name') || $dst.attr('name') }))
          return false
        }
      ...
      date_format: function ($dst, parameters) {
        ...
        if (!moment(that.getValue($dst), parameters).isValid()) {
          that.error($dst, Lang.trans('validation.date_format', {
      ...
      filled: function ($dst, parameters) {
        if (that.getValue($dst) === '') {
          that.error($dst, Lang.trans('validation.filled', { attribute: $dst.attr('name') }))
          return false
        }
        return true
      },
      ...
      integer: function ($dst) {
        ...
        if (typeof value !== 'number' || isNaN(value) || Math.floor(value) !== value || !$.isNumeric(value)) {
          that.error($dst, Lang.trans('validation.integer', { attribute: $dst.data('valid-name') || $dst.attr('name') }))
          return false
        }
        return true
      },
      ...
      ip: function ($dst) {
        ...
        if (!pattern.test(value)) {
          that.error($dst, Lang.trans('validation.ip', { attribute: $dst.data('valid-name') || $dst.attr('name') }))
          return false
        }
      ...
      mimes: function ($dst, parameters) {
        ...
        if (value === '' || exts.indexOf(value.split('.').pop()) === -1) {
          that.error($dst, Lang.trans('validation.mimes', {
            attribute: $dst.data('valid-name') || $dst.attr('name'),
            values: '[' + parameters + ']'
          }))
          return false
      ...
      //
      //   if (value != null) {
      //     that.error($dst, Lang.trans('validation.nullable'))
      //     return false
      //   }
      //
      //   return true
      ...
      regex: function ($dst, pattern) {
        if (!pattern.text(that.getValue($dst))) {
          that.error($dst, Lang.trans('validation.regex', { attribute: $dst.data('valid-name') || $dst.attr('name') }))
          return false
        }
      ...
      json: function ($dst) {
        try {
          ...
          that.error($dst, Lang.trans('validation.json', { attribute: $dst.data('valid-name') || $dst.attr('name') }))
          return false
        }
      },
      ...
      string: function ($dst) {
        if (typeof that.getValue($dst) !== 'string') {
          that.error($dst, Lang.trans('validation.string', { attribute: $dst.data('valid-name') || $dst.attr('name') }))
          return false
        }
      ...
      email: function ($dst, parameters) {
        ...
        if (!val.match(pattern)) {
          that.error($dst, Lang.trans('validation.email', { attribute: $dst.data('valid-name') || $dst.attr('name') }))
          return false
        }
      ...
      url: function ($dst, parameters) {
        ...
        if (!val.match(pattern)) {
          that.error($dst, Lang.trans('validation.url', { attribute: $dst.data('valid-name') || $dst.attr('name') }))
          return false
        }
      ...
      numeric: function ($dst, parameters) {
        ...
        if (typeof num === 'number' && !isNaN(num) && typeof val !== 'boolean') {
          ...
          that.error($dst, Lang.trans('validation.numeric', { attribute: $dst.data('valid-name') || $dst.attr('name') }))
          return false
        }
      },
        ...
        switch (type) {
          ...
          default:
            if (value.length <= parseInt(range[0]) || value.length >= parseInt(range[1])) {
              that.error($dst, Lang.trans('xe::validatorBetween', { between: parameters }))
              return false
            }
        }
      }
    ...
    $(function () {
      ...
      $('form[data-rule]').each(function () {
        if (window.hasOwnProperty('ruleSet')) {
          that.setRules(window.ruleSet.ruleName, window.ruleSet.rules)
        }
      })
    })
  }
