System.import('xecore:/common/js/xe').then(function(XE) {
  ...
  $(function () {
        ...
        var lists = mails.map(function (mail, i) {
          var item = (
            React.createElement(EmailItem, {
              ...
              onDeleteEmail: self.props.onDeleteEmail
            })
          );
        ...
        if (!this.props.isSelectedOrigin) {
          deleteBtns =
            React.createElement('span', {className:"pull-right"},
              React.createElement('a', {ref:"deleteBtn", href:"#", className:"btn btn-sm btn-link", onClick:this.handleDelete}, '삭제'),
              React.createElement('a', {ref:"deleteConfirmBtn", href:"#", style:{display:"none"}, className:"btn btn-sm btn-link", onClick:this.handleDeleteConfirm}, '삭제확인'),
              React.createElement('a', {ref:"deleteCancelBtn", href:"#", style:{display:"none"}, className:"btn btn-sm btn-link", onClick:this.handleDeleteCancel}, '취소')
            )
        }
        return (
          React.createElement('li', {className:"list-group-item clearfix"},
            React.createElement('label', null,
              React.createElement('input', {type:"radio", ref:"input", onChange:this.handleChange, name:"email", value:mail.address, checked:this.props.isSelected}),
              ' '+ mail.address
            ),
            deleteBtns
          )
    ...
    var EmailInserter = React.createClass({
      ...
      render: function () {
        return (
          React.createElement('div', {className:"input-group input-group-sm", style:{marginBottom:"20px"}},
            React.createElement('input', {type:"text", className:"form-control", id:"__xe_addedEmailInput", ref:'input', placeholder:"이메일을 입력하세요"}),
            React.createElement('span', {className:"input-group-btn"},
              React.createElement('buttion', {id:"__xe_emailAddBtn", className:"btn btn-default", type:"button", onClick:this.handleClick, ref:"btn"}, '추가')
            )
          )
